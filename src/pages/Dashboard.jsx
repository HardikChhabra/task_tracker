...
export const Dashboard = ({ user, token, onLogout }) => {
  ...
  const handleUpdateTask = async (taskData) => {
    try {
      const updated = await TaskService.updateTask(taskData.id, taskData, token);
      ...
      <nav className="bg-neutral-800 border-b border-neutral-700 px-6 py-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold text-neutral-100">Task Manager</h1>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        <div className="grid grid-cols-3 gap-4 mb-8">
          <div className="bg-neutral-800 border border-neutral-700 rounded-lg p-6">
            ...
            <div className="text-3xl font-bold text-neutral-100">{stats.total}</div>
          </div>
          <div className="bg-neutral-800 border border-neutral-700 rounded-lg p-6">
            <div className="text-neutral-400 text-sm mb-1">Completed</div>
            <div className="text-3xl font-bold text-neutral-100">{stats.completed}</div>
          </div>
          <div className="bg-neutral-800 border border-neutral-700 rounded-lg p-6">
            <div className="text-neutral-400 text-sm mb-1">Pending</div>
            <div className="text-3xl font-bold text-neutral-100">{stats.pending}</div>
          </div>
        </div>
